...
public class AccommodationSummary {
	...
	private int accommodates; // accommodates
	...
	public void setAccomodates(int accommodates) { this.accommodates = accommodates; }
	public int getAccomodates() { return this.accommodates; }
