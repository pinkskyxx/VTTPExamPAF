...
public class ListingsService {
	...
	public void createBooking(Bookings booking) {
		...
		String chkUser = booking.getEmail();
		Optional<User> user = bookingRepo.userExists(chkUser);
		System.out.println(user);
		if (user.isEmpty()) {
			User newUser = new User(chkUser, booking.getName());
			bookingRepo.newUser(newUser);
		}
