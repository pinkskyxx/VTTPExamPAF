...
public class BookingsRepository {
	...
	public void newUser(User user) {
		template.update(SQL_INSERT_NEW_USER, user.name(), user.email());
	}
	...
	public void newBookings(Bookings bookings) {
		template.update(SQL_INSERT_NEW_USER, bookings.getBookingId(), bookings.getListingId(), bookings.getEmail(), bookings.getEmail());
	}
}
